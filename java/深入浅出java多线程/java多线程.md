[网页地址](http://concurrent.redspider.group/)
...
可以看到，当对象状态为偏向锁时，`Mark Word`存储的是偏向的线程ID；当状态为轻量级锁时，`Mark Word`存储的是指向线程栈中`Lock Record`的指针；当状态为重量级锁时，`Mark Word`为指向堆中
...
![img](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/%E5%81%8F%E5%90%91%E9%94%812.jpg)
...
![img](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/%E5%81%8F%E5%90%91%E9%94%81.png)
...
![img](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/%E8%BD%BB%E9%87%8F%E7%BA%A7%E9%94%81%E6%B5%81%E7%A8%8B%E5%9B%BE.png)
...
![img](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/%E5%8E%9F%E5%AD%90%E7%B1%BB.jpg)
...
![img](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/AQS%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84.png)
...
![img](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/acquire%E6%B5%81%E7%A8%8B.jpg)
...
![img](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/%E7%BA%BF%E7%A8%8B%E6%B1%A0%E4%B8%BB%E8%A6%81%E7%9A%84%E5%A4%84%E7%90%86%E6%B5%81%E7%A8%8B.png)
...
整体架构(列举常用的容器类)![img](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/%E5%B9%B6%E5%8F%91%E5%AE%B9%E5%99%A8.png)
...
有些方法需要跨段，比如size()、isEmpty()、containsValue()，它们可能需要锁定整个表而而不仅仅是某个段，这需要按顺序锁定所有段，操作完毕后，又按顺序释放所有段的锁。如下图：![分段锁机制](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/%E5%88%86%E6%AE%B5%E9%94%81%E6%9C%BA%E5%88%B6.png)
...
```
private final AtomicReference<QNode> evenQ;private final AtomicReference<QNode> oddQ;
static final class QNode implements ForkJoinPool.ManagedBlocker {    // 实现代码}
```
...
![img](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/fork_join%E6%B5%81%E7%A8%8B%E5%9B%BE.png)
...
![img](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/%E5%B7%A5%E4%BD%9C%E7%AA%83%E5%8F%96%E7%AE%97%E6%B3%95%E8%BF%90%E8%A1%8C%E6%B5%81%E7%A8%8B%E5%9B%BE.png)
...
我们在之前介绍过说Thread.join()会使线程阻塞，而ForkJoinPool.join()会使线程免于阻塞，下面是ForkJoinPool.join()的流程图：![join流程图](java%E5%A4%9A%E7%BA%BF%E7%A8%8B.assets/join%E6%B5%81%E7%A8%8B%E5%9B%BE.png)
